...
console.log('Ergebnis One', theLastname[3].toUpperCase())


// // substring() und Trim()
console.log("<---substring()--Trim()--toUpperCase()---->")
let test = "javaScript";
console.log(test.substring(4,10) +  " " + test.substring(0))// sunche nach dem Word
// // -----
...
let sub = "Schule"; 
if(sub.length <= 6){
    console.log(`Unterricht fängt um 10:00  bei der ${sub} an`,sub.substring(4,5)) // l 
}else{
